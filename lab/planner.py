...
Parameters and inclusive bounds: {json.dumps(spec.bounds)}. {spec.units} Seeds are distinct integers in [100000,900000000], separated by at least 100. Title at most 120 characters. Names at most 45 characters. Each scenario needs a specific rationale. Use systematic coverage with some combinations, not duplicates.
